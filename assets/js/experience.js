...
const exp = [
  {
    ...
    cardImage: "assets/images/experience-page/stratos.jpg",
    place: "Stratos Studios",
    time: "(February, 2022 - Present)",
    desp: "",
  },
  {
    title: "Applied Machine Learning Scholar (Engineer)",
  ...
  },
  {
    ...
    desp: "<li>Worked on different of projects with several teams and responsible for implementing a plan with errors being fixed, involved in planning and implementing strategies for quality management.</li><li>Along with that, involved in Data Analysis - Performing analysis to assess quality and meaning of data, Preparing final analysis reports, Fixing coding errors (Python) and related problems and maintaining databases, data systems.</li><li>Experience in Python Development, Information Processing, Data Visualization and Analysis.</li><li>Track weekly data to chart whether the departments hit goals. Produced reports and presentations using software.</li>",
  },
